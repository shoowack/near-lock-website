  ...
  >
    <div className="row">
      <div className="col-md-4 three-d-touch">
        <img src="/feature/3d_touch_icon_sub.svg" alt="" className="feature-icon" />
        <h4>3D Touch</h4>
      ...
      <div className="col-md-4 notification_center_icon">
        <img src="/feature/notification_center_icon.svg" alt="" className="feature-icon" />
        <h4>Notification Center</h4>
        <p className="text-left">
          Swipe down on your iPhone home screen to access your Notification Center.
          <br />
          <br />
          Using the{' '}
          <a
        ...
        <ul className="text-left">
          ...
          <li>copy and paste clipboard from your iPhone to your Mac and vice versa.</li>
        </ul>
      </div>
      <div className="col-md-4 interactive_notifications_icon">
        ...
        <p className="text-left">
          You don&apos;t even need to open the Near Lock app on your iPhone to unlock your Mac.
          <br />
          <br />
          Using the <a href="#unlock-options">Mac Wake Unlock</a> option you will receive a
          notification on your iPhone every time your Mac is woken up from sleep.You can then unlock
          your Mac directly through the received notification.
          <br />
          <br />
          {/* <ul>
            <li>
    ...
    <div className="row">
      <div className="col-md-4 col-sm-4 d-none d-md-block">
        <img src="/feature/3d-touch-iphone.png" className="img-fluid center-block" alt="" />
      </div>
      <div className="col-md-4 col-sm-4 d-none d-md-block">
        <img
