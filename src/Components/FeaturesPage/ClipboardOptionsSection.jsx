          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-6 order-md-0 feature_menubar__content d-flex justify-content-center flex-column px-5">
                ...
                <p>
                  Near Lock allows you to send clipboard text from your Mac to
                  your iPhone. Either press the shortcut button in the{" "}
            ...
            <div className="row">
              <div className="col-md-6 order-md-1 feature_clipboard_ios__content d-flex justify-content-center flex-column mt-4 mt-md-0 px-5">
                ...
                <p>
                  The Near Lock app on your iPhone allows you to send the
                  current clipboard text from your iPhone to your Mac but also
                  to fetch the current clipboard from your Mac to your iPhone.
                  <br />
                  <br />
