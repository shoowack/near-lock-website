...
function HashLinkPage({ location }) {
  ...
  return (
    <div>
      <section
        style={objectAssign({ backgroundColor: "#E0E0E0" }, sectionStyle)}
        id="section-one"
      >
        ...
        <ul>
          <Li>
            <Interactive as={HashLink} {...linkStyle} to="/">
              Home
            </Interactive>
          </Li>
          <Li>
      ...
      <section
        style={objectAssign({ backgroundColor: "#D0D0D0" }, sectionStyle)}
        id="section-two"
      >
      ...
      >
        ...
        <ul>
          ...
          <Li>
            <Interactive as={HashLink} smooth {...linkStyle} to="#top">
              Top of Page
            </Interactive>
          </Li>
        </ul>
